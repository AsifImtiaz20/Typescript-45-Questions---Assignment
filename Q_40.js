...
// console.log(album2);
// console.log(album3);
function myAlbum(artistName, albumTitle, numbersOfTracks) {
    return { artistName: artistName, albumTitle: albumTitle, numbersOfTracks: numbersOfTracks };
}
var album1 = myAlbum("Ali", "Junoon", 40);
var album2 = myAlbum("Zafar", "PSL", 90);
var album3 = myAlbum("Rahat", "COckStudio");
console.log(album1);
console.log(album2);
console.log(album3);
