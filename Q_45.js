...
function carDetails(manufacturer, modelNum) {
    var additionalInfo = [];
    for (var _i = 2; _i < arguments.length; _i++) {
        additionalInfo[_i - 2] = arguments[_i];
    }
    var car = __assign({ manufacturer: manufacturer, modelNum: modelNum }, Object.fromEntries(additionalInfo));
    return car;
}
;
var myCarDetails = carDetails("Toyota", "Corolla 2017", ["colour", "blue"], ["year", 2017]);
