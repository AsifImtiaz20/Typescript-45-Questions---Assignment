...
let current_users = ["Ali", "Salman", "Sultan", "Abrar", "Asfand", "Faisal"];

let new_users = ["Nadeem", "Khalid", "Sultan", "Asfand", "Shahid", "Shoaib"];
...
if(userNameTaken){
    console.log(`${new_users} need to chosse a new username because it is already taken`);    
